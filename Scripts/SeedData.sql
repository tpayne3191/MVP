...
INSERT INTO Campaign([Name], DateStarted, DateEnded)
    VALUES
...
INSERT INTO Player([Name], Phone, Email, City)
    VALUES
...
INSERT INTO Weapon([Name], Damage, [Range], [Description])
    VALUES
...
INSERT INTO [Character](PlayerId, [Name], CampaignId, [Level], ArmorClass, HitPoints, Strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma, Race, Alignment, Class, [Image])
    VALUES
        ('1', 'Rin Aralysin', '1', '5', '18', '46', '18', '8', '14', '8', '9', '14', 'Aasimar', 'Lawful Good', 'Paladin', 'https://www.imageoofsomethingorother.com'),
        ('2', 'Sinsien Dar', '1', '5', '14', '22', '8', '14', '12', '18', '8', '16', 'Tiefling', 'Chaotic Neutral', 'Wizard', 'https://www.imageoofsomethingorother2.com'),
        ('3', 'Eslilda Opalknuckle', '1', '5', '15', '36', '10', '16', '14', '10', '18', '12', 'Half-Orc', 'Neutral Evil', 'Warlock', 'https://www.imageoofsomethingorother3.com'),
        ('4', 'Yurali Oriphi', '1', '5', '16', '52', '16', '12', '18', '8', '8', '16', 'Human', 'Neutral Good', 'Cleric', 'https://www.imageoofsomethingorother4.com');




INSERT INTO CharacterWeapon(CharacterId, WeaponId, Quantity)
    VALUES
        ('1', '3', '1'),
        ('2', '5', '1'),
        ('3', '2', '2'),
